...
#define TURN_SPEED                22   // Dönüş başlangıç PWM hızı (statik sürtünmeyi yenmek için)
#define TURN_SPEED_SLOW            8   // Çizgi yaklaşınca yavaşlama hızı (hassas hizalama)
...
#define OBSTACLE_DISTANCE_CM   10    // Bu cm altında engel var sayılır
#define SONAR_INTERVAL        100    // Sonar ölçüm aralığı (ms)
